...
static void ConfigurarServices(WebApplicationBuilder builder)
{
    ...
    builder.Services.AddSwaggerGen(c =>
    {
        ...
        c.SwaggerDoc("v1", new OpenApiInfo { Title = "AgendaTelefonica.Api", Version = "v1" });
    });
...
static void ConfigurarAplicacao(WebApplication app)
{
    ...
    app.UseSwagger()
        .UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "AgendaTelefonica.Api v1");
